            ...
            <div class="row align-items-stretch">
                <div class="col-lg-4">
                    <div class="h-90 bg-white box box-offset">
                        ...
                        <p>Уже {{ $since }} наша компания <b>Dekor Technology</b> занимается производством и оформлением декораций для различных мероприятий. За это время мы смогли наладить собственное производство и собрать команду высококвалифицированных специалистов, которые готовы выполнить ваш заказ любой сложности.</p>
